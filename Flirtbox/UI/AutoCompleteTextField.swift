...
public class AutoCompleteTextField:UITextField, UITableViewDataSource, UITableViewDelegate{
    ...
    private func setupAutocompleteTable(view:UIView){
        ...
        let tableView = UITableView(frame: CGRectMake(self.frame.origin.x - 10, self.frame.origin.y + CGRectGetHeight(self.frame) - 20, screenSize.width - (self.frame.origin.x * 2), 30.0))
