//
//  FacebookAuthClient.swift
//  Flirtbox
//
//  Created by Azamat Valitov on 24.12.15.
...
class FacebookAuthClient: HeimdallrHTTPClient {
    ...
    @objc func sendRequest(request: NSURLRequest, completion: (data: NSData?, response: NSURLResponse?, error: NSError?) -> ()) {
        var urlString = String.FBURL(FBNet.FACEBOOK_SIGNUP)
    ...
    static let sharedInstance = FacebookAuthClient()
